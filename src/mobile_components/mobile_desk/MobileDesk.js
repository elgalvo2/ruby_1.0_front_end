...
export default function MobileDesk() {
    ...
    const  [tasks,openSendMarkDone, markDoneId,removetask,markAsDone,handleMarkDone]= useManageTasks(logedin,newTask)
        ...
        <>
            {(logedin) ?
                <>
                    <div className={styles.layout} style={{ width }}>
                        ...
                        <div className={styles.visor}>
                            {tasks.map((task, index)=>(
                                <TaskCard methods={{removetask,handleMarkDone}} key={index} cardData={task} onClick={()=>handleMarkDone(true,task._id)}/>
                            ))}
                        </div>
                    ...
                    <MarkDoneDialog open={openSendMarkDone} methods={{markAsDone,handleMarkDone}}/>
