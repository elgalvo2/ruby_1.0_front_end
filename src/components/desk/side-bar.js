...
export default function SideBar({methods}) {
  ...
  return (
    <Paper varian='outlined' component={Grid} direction='row' alingItems='stretch'>
      <Grid item>
        <Box sx={{width: '100%', maxWidth: 360, bgcolor: 'background.paper' }} >
        <Box>
          <Typography sx={{height:'100vh', maxHeight:200}} variant='h4'>Signature</Typography>
          <Typography sx={{height:'100vh', maxHeight:200}}  variant='h2'>RUBY</Typography>
